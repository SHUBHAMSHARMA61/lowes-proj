...
const checkAuthenticated = function(req, res, next){
    if(req.isAuthenticated()){
        res.set('Cache-Control', 'no-cache, private, no-store, must-revalidate, post-checked, pre-checked' );
        return next();
    }else{
        res.redirect('/login');
    }
...
mongoose.connect('mongodb+srv://shubham61:shubham61@cluster0-qlynr.mongodb.net/test?retryWrites=true&w=majority', {
